...
global.vs = '2.1.5'
global.vsJB = '5.0'
global.nameqr = '𝑰𝒎𝒑𝒂𝒄𝒕𝒊𝒏𝒈 - 𝒏𝒆𝒕𝒘𝒐𝒓𝒔 - 𝒃𝒐𝒕'
global.namebot = '✿◟𝒊𝒎𝒑𝒂𝒄𝒕𝒊𝒏𝒈-𝒏𝒆𝒕𝒘𝒐𝒓𝒔-𝑩𝒐𝒕◞✿'
global.sessions = 'Sessions'
global.jadi = 'JadiBots' 
global.ImpactingJadibts = true

//*─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─*

global.packsticker =`°.⎯⃘̶⎯̸⎯ܴ⎯̶᳞͇ࠝ⎯⃘̶⎯̸⎯ܴ⎯̶᳞͇ࠝ⎯⃘̶⎯̸.°\n✦ Bσƚ:\n✦ Pɾσριҽƚαɾισ:\n✦ Fҽƈԋα ԃҽ Cɾҽαƈιóɳ:\n✦ Hσɾα ԃҽ Cɾҽαƈιóɳ:\n♾━━━━━━━━`
global.packsticker2 = `━━━━━━━━♾\n⪛·:*¨♱cuti-agency-bot♱ ¨*:·⪜\n⋆ ༺Ƹ (ꐦ ◣‸◢) 𝙼𝙰𝚁𝚃𝙸𝙽𝙴𝚉\n⇝ ${moment.tz('america/Los_angeles').format('DD/MM/YY')}\n⇝ ${moment.tz('America/Los_angeles').format('HH:mm:ss')} \n°.⎯⃘̶⎯̸⎯ܴ⎯̶᳞͇ࠝ⎯⃘̶⎯̸⎯ܴ⎯̶᳞͇ࠝ⎯⃘̶⎯̸.°\n\nѕτιϲκєя ϐγ: 𝑰𝒎𝒑𝒂𝒄𝒕𝒊𝒏𝒈-𝒏𝒆𝒕𝒘𝒐𝒓𝒔-𝑩𝒐𝒕`

//*─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─*

global.packname = `⪛✰¨♱𝑰𝒎𝒑𝒂𝒄𝒕𝒊𝒏𝒈-𝒏𝒆𝒕𝒘𝒐𝒓𝒔-𝑩𝒐𝒕¨*:·`
global.botname = '·:*¨♱𝑰𝒎𝒑𝒂𝒄𝒕𝒊𝒏𝒈-𝒏𝒆𝒕𝒘𝒐𝒓𝒔-𝑩𝒐𝒕♱ ¨*:·'
global.wm = 'ৎ୭࠭͢𓆪͟͞ 𝑰𝒎𝒑𝒂𝒄𝒊𝒕𝒏𝒈-𝒏𝒆𝒕𝒘𝒐𝒓𝒔-𝑩𝒐𝒕'
global.author = 'Made By 𝑰𝒎𝒑𝒂𝒄𝒕𝒊𝒏𝒈'
global.dev = '© ⍴᥆ᥕᥱrᥱძ ᑲᥡ  𝑰𝒎𝒑𝒂𝒄𝒕𝒊𝒏𝒇'
global.textbot = ' 𝑰𝒎𝒑𝒂𝒄𝒕𝒊𝒏𝒇 • P·:*¨♱𝑰𝒏𝒑𝒂𝒄𝒕𝒊𝒏𝒈-𝒏𝒆𝒕𝒘𝒐𝒓𝒔-𝑩𝒐𝒕♱ ¨*:·'

global.moneda = 'cutimonedas'
